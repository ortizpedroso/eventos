...
- [x] `main` em `0e7e784` — inclui taxa zero em ingresso grátis/cortesia + backfill do Financeiro (§2.1.1), home Comprar × Sou produtor + scroll-reveal, além de tudo das versões anteriores
