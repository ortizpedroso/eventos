...
- [x] tip de produto — `9082c90` (L1 DELETE+usado; L2 parcial na spec); SEO `8b6759c` / fix teste `f3f2e8b`; lint `12ec50f`; §2.10 `eea493d`. Hash = último commit de produto; commits `docs(spec): …` não entram neste ponteiro.
