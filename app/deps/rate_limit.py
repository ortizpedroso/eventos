...
def rate_limit_lista_publica(request: Request, slug: str = "") -> None:
    ip = _client_ip(request)
...
def rate_limit_ingresso_vincular(request: Request) -> None:
    enforce_rate_limit(request, "ingresso_vincular")
