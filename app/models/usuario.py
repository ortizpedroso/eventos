...
class Usuario(Base):
    ...
    onboarding_conta_email_event = Column(String(32), nullable=True)
    assinatura_tracker_status = Column(String(32), nullable=True)
    assinatura_tracker_falha_motivos = Column(Text, nullable=True)
