...
async def lifespan(app: FastAPI):
    ...
    from app.services.contato_email import start_contato_email_worker, stop_contato_email_worker
    ...
    from app.services.lembrete_carrinho import (
        start_lembrete_carrinho_worker,
        stop_lembrete_carrinho_worker,
    )
...
app = FastAPI(
    title="EventosBR API",
    description=(
        "API da EventosBR: eventos, ingressos, pagamentos PIX/cartão, "
