...
export default function AjudaParcelamentoTaxasPage() {
  return (
    <AjudaArticle title="Parcelamento e taxas" current="/ajuda/parcelamento-e-taxas">
      <p>
        A taxa EventosBR é <strong>fixa por ingresso</strong> ({rotuloTaxa(TARIFA_PADRAO)} no plano
        padrão) — igual para PIX, cartão à vista ou parcelado. O processador de pagamento fica
        embutido; você não vê taxas separadas de processamento no checkout.
      </p>
      <h2>Parcelamento</h2>
      <p>
      ...
      <p>
        Repasses são automáticos no momento da venda (split). O extrato em Financeiro mostra o
        líquido por ingresso.
      </p>
