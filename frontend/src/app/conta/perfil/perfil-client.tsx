...
export function PerfilClient() {
  ...
  return (
    <div className="space-y-6">
      ...
      <section className="max-w-lg rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm sm:p-8">
        {!editando ? (
          <>
            <div className="flex flex-wrap items-start justify-between gap-3">
              <div>
                <h2 className="text-lg font-semibold text-zinc-900">Minhas informações</h2>
                <p className="mt-1 text-sm text-zinc-600">Dados salvos na EventosBR.</p>
              </div>
              <button
                type="button"
