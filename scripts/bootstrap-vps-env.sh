...
# Usa printf/_write_env em vez de heredoc com expansão, para evitar que valores com
# $, backticks ou aspas (em senhas/chaves) sejam expandidos pelo bash ao escrever o arquivo.
_write_env() {
  local key="$1"
  local val="$2"
